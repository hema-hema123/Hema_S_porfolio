...
const socials = [
  ...
  {Icon : FaLinkedin,label:"LinkedIn",href:"https://www.linkedin.com/in/hemas123/"}, 
...
const glowVariants = {
  ...
  hover: {
    scale:1.2,y:-3,
    filter:"drop-shadow(0 0 8px rgba(13,88,204,0.9)) drop-shadow(0 0 20px rgba(16,185,129,0.8))",
  ...
  return (
    ...
    id="home" className='w-full h-screen relative bg-black overflow-hidden'>
      ...
      >
        ...
        rounded-full
        bg-gradient-to-r from-[#302b63] via-[#af62c6] to-[#1cd8d2]
      ...
      >
  <div className='flex flex-col justify-center h-full text-center lg:text-left relative px-4 lg:pl-30'
  >
          <div  className='w-full lg:pr-24 mx-auto max-w-[48em]'
          >
            <motion.div
            className='mb-3 text-xl sm:text-2xl md:text:3xl lg:text-4xl font-semibold text-white tracing-wide min-h-[1.6em]'
            ...
            bg-gradient-to-r from-[#cecbef] via-[#decde4] to-[#1cd8d2]drop-shadow-lg'
            initial={{opacity:0, y:12}}
            animate={{opacity:1, y:0}}
  ...
  My Resume
      ...
      >
        ...
        style={{
          ...
          background:"conic-gradient(from 0deg,from-[#302b63] via-[#af62c6] to-[#D88FF4])"        }}
        />

        <motion.img src={myrobo} alt='My Robo'
        className=' absolute bottom-20 right-0 left-5 object-contain pointer-events-none'
        style={{
          right:"-30px", width:"min(45svw, 780px)" ,maxHeight:"90vh"
        }}
