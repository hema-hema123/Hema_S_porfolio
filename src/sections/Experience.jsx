...
const experiences = [

  {
    ...
    company:"none",
    duration:"none",
    description: "Built Climora, an AI-powered dashboard that analyzes urban heat patterns using satellite data and geospatial visualization to support climate-resilient planning.Technical Exposure: REST APIs, data visualization, networking, multi-threading, NLP, Docker, and cloud deployment.",
  ...
  },
  {
    ...
    company:"none",
    duration:"none",
    description:"Designed and implemented scalable software systems using C++, Python, and web technologies for data analysis, networking, and backend services.",
  },

  {
    ...
    if(layout === "desktop"){
        return(
            ...
            >
                <motion.div className="z-10 w-7 h-7 rounded-full bg-white  shadow-[0_0_0_8px_rgba(225,225,225,0.1)]"
                style={{ scale,opacity}}
                >
    ...
    return(
        ...
        >
            <motion.div className="absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(225,225,225,0.1)]"
            style={{scale,opacity}}
            >

            </motion.div>
            <motion.article className="bg-gray-900/80 background-blur border-gray-700/70 rounded-xl p-5 w-[90vw] max-w-sm ml-6 shadow-lg"
            style={{opacity,x}}
            transition={{duration : 0.4 , delay : idx*0.15}}
            >
    ...
    return(
        <section id="experience" className="relative bg-black text-white">
            ...
            >
                ...
                >
                    <h2 className="text-4xl sm:text-4xl font-semibold mt-5 text-center   "
                    >
                    ...
                    <div className="flex flex-1 items-center justify-center px-6 pb-10">
                        ...
                        {isMobile && (
                            ...
                            >
                                <div className="absoluute left-0 top-0 bottom-0 w-[6px] bg-white/15 rounded "
                                >
